...
const localeCopies: Record<Locale, LocaleCopy> = {
  'zh-HK': {
    ...
    competitionScore: '總分',
    competitionMatchesPlayed: '完成半莊數',
    competitionMatches: '查看半莊結果',
    competitionResults: '半莊結果',
    ...
    competitionMatchDetails: '半莊詳情',
    competitionMatchStatus: (status) =>
      ({scheduled: '已排期', completed: '已完成', cancelled: '已取消'})[status],
    competitionMatchSequence: (sequence) => `半莊 ${String(sequence).padStart(2, '0')}`,
    competitionMatchTypeCount: (count) => `${count} 場半莊`,
    competitionResultsEmpty: '完成半莊後，結果將會顯示在這裡。',
    ...
    competitionNoRankings: '完成半莊後，排名將會顯示在這裡。',
    members: '成員',
  ...
  en: {
    ...
    competitionMatchesPlayed: 'Hanchans played',
    competitionMatches: 'View hanchan results',
    competitionResults: 'Hanchan results',
    ...
    competitionMatchDetails: 'Hanchan details',
    competitionMatchStatus: (status) =>
      ({scheduled: 'Scheduled', completed: 'Completed', cancelled: 'Cancelled'})[status],
    competitionMatchSequence: (sequence) => `Hanchan ${String(sequence).padStart(2, '0')}`,
    competitionMatchTypeCount: (count) => (count === 1 ? '1 hanchan' : `${count} hanchans`),
    competitionResultsEmpty: 'Completed hanchan results will appear here.',
    ...
    competitionNoRankings: 'Rankings will appear here after completed hanchans.',
    members: 'Members',
  ...
  ja: {
    ...
    competitionMatchesPlayed: '半荘数',
    competitionMatches: '半荘結果を見る',
    competitionResults: '半荘結果',
    ...
    competitionMatchDetails: '半荘詳細',
    competitionMatchStatus: (status) =>
      ({scheduled: '予定', completed: '完了', cancelled: '中止'})[status],
    competitionMatchSequence: (sequence) => `半荘 ${String(sequence).padStart(2, '0')}`,
    competitionMatchTypeCount: (count) => `${count} 半荘`,
    competitionResultsEmpty: '半荘が完了すると結果が表示されます。',
    ...
    competitionNoRankings: '半荘が完了するとランキングが表示されます。',
    members: 'メンバー',
